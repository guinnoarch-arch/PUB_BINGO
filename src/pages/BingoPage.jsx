...
export default function BingoPage() {
  const { api, userId, authReady, pubsById, favourites, changeVersion, toast } = useApp();
  ...
  const card = useMemo(() => buildCardState(progress || [], auto), [progress, auto]);
  ...
  return (
    <>
      <section className={`hero-card ${lines.length ? "bingo" : ""}`}>
        <div>
          <p className="eyebrow">Your challenge card</p>
